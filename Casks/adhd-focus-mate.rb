cask "adhd-focus-mate" do
  ...
  url "https://github.com/skainguyen1412/adhd-focus-timer/releases/download/v#{version}/ADHD-Focus-Mate.zip"
  name "ADHD Focus Mate"
  desc "The ADHD timer that sees your distractions before you get lost in them"
  homepage "https://github.com/skainguyen1412/adhd-focus-timer"
